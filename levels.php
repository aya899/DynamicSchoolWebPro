...
if(isset($_POST['submit'])){
  $search=$_POST['search'];
  if(!empty($search)){
   $sql="SELECT * FROM levels where `grade` like '%$search%'";
...
<div class="container">
<button type="button" class="btn btn-primary" name="addlevel" ><a href="addlevels.php">Add Level</a></button>

							 
   
                                                                                                                                    
  <h2  style="color:#fff;">Levels Data</h2>
    ...
    <tbody>
      ...
      <?php
         ...
         <td><?php echo $row['lid'] ?></td>
            ...
            <td>
            <a href="editlevels.php?lid=<?php echo $row['lid']?>"> <img src="./images/edit1.png" alt="Edit" width="30px" height="30px"> </a>
             </td>
             <td>
          <a href="deletelevels.php?lid=<?php echo $row['lid']?>"><img src="./images/delete1.png" alt="Delete" width="30px" height="30px"></a>
         </td>
        </tr>
