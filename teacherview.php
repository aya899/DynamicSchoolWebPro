...
$query="
SELECT tid, tname, temail, subname FROM
teachers t INNER JOIN subjects s
ON t.subid= s.subid";
...
if(isset($_POST['submit'])){
    $search=$_POST['search'];
    if(!empty($search)){
     $sql="SELECT * FROM teacherview where `tname` like '%$search%'";
...
<div class="container" >
    ...
    <h2 style="color:#fff;">Teachers View Data</h2>
