...
if(isset($_POST['submit'])){
  $search=$_POST['search'];
  if(!empty($search)){
   $sql="SELECT * FROM teachers where `tname` like '%$search%'";
...
<button type="button" class="btn btn-primary" name="addlevel"><a href="addteachers.php">Add Teacher</a></button>
  <h2 style="color:#fff;">Teachers Data</h2>
    ...
    <tbody>
      ...
      <?php 
         ...
         <td><?php echo $row['tid'] ?></td>
            ...
            <td>
            <a href="editteachers.php?tid=<?php echo $row['tid']?>"> <img src="./images/edit1.png" alt="Edit" width="30px" height="30px"> </a>
             </td>
             <td>
          <a href="deleteteachers.php?tid=<?php echo $row['tid']?>"><img src="./images/delete1.png" alt="Delete" width="30px" height="30px"></a>
         </td>
        </tr>
