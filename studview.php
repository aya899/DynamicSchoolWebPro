...
include("dbconn.php");
$query="
SELECT sid, sname, semail, slevel, grade, roomnumber FROM
students s, levels l, classrooms c where
s.lid = l.lid
and s.cid=c.cid";
...
if(isset($_POST['submit'])){
    $search=$_POST['search'];
    if(!empty($search)){
     $sql="SELECT * FROM studentview where `sname` like '%$search%'";
...
<div class="container"  >
    ...
    <h2 style="color:#fff;">Students View Data</h2>
