...
if(isset($_POST['submit'])){
  $search=$_POST['search'];
  if(!empty($search)){
   $sql="SELECT * FROM subjects where `subname` like '%$search%'";
...
<div class="container">
    ...
    <button class="btn btn-primary" type="button" ><a href="addsubjects.php">Add Subject</a></button>
                                                                                                                                    
 
  <h2 style="color:#fff;">Subjects Data</h2>
    ...
    <tbody>
      ...
      ?>
        ...
        <td><?php echo $row['subid'] ?></td>
            ...
            <td>
             <a href="editsubjects.php?subid=<?php echo $row['subid']?>"> <img src="./images/edit1.png" alt="Edit" width="30px" height="30px"> </a>
            </td>
            <td>
              <a href="deletesubjects.php?subid=<?php echo $row['subid']?>"><img src="./images/delete1.png" alt="Delete" width="30px" height="30px"></a>
            </td>
            <?php
            }
            } else {
