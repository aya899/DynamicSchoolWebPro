...
<div class="container">
        ...
        <button class="btn btn-primary" type="button"><a href="addstudents.php">Add Student</a></button>


 
    <h2  style="color:#fff;">Students Data</h2>
            ...
            if (mysqli_num_rows($res) > 0) {
                foreach ($res as $row) {
                    ...
                    <td><?php echo $row['sid']; ?></td>
                        ...
                        <td>
                            <a href="editstudents.php?sid=<?php echo $row['sid']; ?>"><img src="images/edit1.png" alt="Edit" width="30px" height="30px"></a>
                        </td>
                        <td>
                            <a href="deletestudents.php?sid=<?php echo $row['sid']; ?>"><img src="images/delete1.png" alt="Delete" width="30px" height="30px"></a>
                        </td>
